...
//			String code = "" + empno.charAt(0);		//'5'  --> "5"
			...
			int nightpay = this.getNigthpay(emp.getNight()); 	//야근수당
	...
	private int getBase(int base) { // 기본급수당을 얻기 위한 메소드
		int[] bases = { 15000, 250000, 35000, 45000 };
		return bases[base - 1];
	...
	private int getNigthpay(int night) {
